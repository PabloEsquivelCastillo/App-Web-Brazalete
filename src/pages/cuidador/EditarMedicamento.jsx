...
const EditarMedicamentoCuidador = () => {
    ...
    const handleSubmit = (values) => {
        ...
        .then((res) => {
            if(res.status === 200) {
                navigate("/cuidador/Medicamentos")  // Cambiado a ruta de cuidador
            } else {
...
export default EditarMedicamentoCuidador;